...
ColumnLayout {
    ...
    SettingCard {
        ...
        description: qsTr("Hover to make the widget transparent and let clicks go through, move away to bring it back")
    ...
    SettingCard {
        ...
        description: qsTr("Click on the widget to hide it, click it again to bring it back")
    ...
    SettingExpander {
        ...
        action: ComboBox {
            ...
            textRole: "text"
            valueRole: "value"
            onCurrentValueChanged: if (focus) Configs.set("interactions.hide.mini_mode", currentValue)
            Component.onCompleted: currentIndex = Configs.data.interactions.hide.mini_mode ? 1 : 0
        }
